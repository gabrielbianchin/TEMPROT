...
X_train = np.load('/data/embedding/bp-X_train.npy')
X_val = np.load('/data/embedding/bp-X_val.npy')
X_test = np.load('/data/embedding/bp-X_test.npy')
...
np.save('predictions/bp-temprot.npy', pred)