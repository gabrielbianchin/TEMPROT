...
model_path = '/weights/mf-fine-tuned/weights-01.hdf5'
model, tokenizer = get_model(model_name, model_path)

################ Training #####################
file_path = '/data/embedding/mf-X_train.npy'
last_saved_i = -1
...
################ Validation #####################
file_path = '/data/embedding/mf-X_val.npy'
last_saved_i = -1
last_saved_emb = np.array([])
...
################ Test #####################
file_path = '/data/embedding/mf-X_test.npy'
last_saved_i = -1
last_saved_emb = np.array([])
