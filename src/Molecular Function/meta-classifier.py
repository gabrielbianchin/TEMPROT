...
data_augmentation = pd.read_csv('data/mf-augmented_training.csv')
...
X_train = np.load('/data/embedding/mf-X_train.npy')
X_val = np.load('/data/embedding/mf-X_val.npy')
X_test = np.load('/data/embedding/mf-X_test.npy')
...
np.save('predictions/mf-temprot.npy', pred)